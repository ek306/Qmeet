...
from qmeet.models import Student
...
class Message(models.Model):
    ...
    sender = models.ForeignKey(Student, related_name='sent_messages', verbose_name=_("Sender"), on_delete=models.PROTECT)
    recipient = models.ForeignKey(Student, related_name='received_messages', null=True, blank=True, verbose_name=_("Recipient"), on_delete=models.SET_NULL)
